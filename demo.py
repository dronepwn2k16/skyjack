...
from command.video_pwn import Videofaker
from autopwn import pwn
import mpwn
from command.blockotherscommand import blockothers as dirty
...
if __name__ == '__main__':
    ...
    skyjack.register_command(video)
    ...
    # unblock others by default
    try:
        dirty(interface, True)
    except Exception:
        exit(0)
